...
=======
# 🚀 TSP Route Optimizer - Etapa 2 CLI Concluída
...
### CLI (Etapa 2) ✅
- Carregamento e criação de grafos de pontos
- Execução de algoritmos TSP (Nearest Neighbor, Brute Force)
- Comparação de performance entre algoritmos
- Demonstração interativa de todos os conceitos POO
